...
use App\Models\{Category,Coupon,Order,Product,User};
...
class AdminController extends Controller
{
 ...
 public function deleteProduct(Product $product){abort_if($product->orderItems()->exists(),422,'Ordered products cannot be deleted.');$product->delete();return back()->with('success','Product deleted.');}
